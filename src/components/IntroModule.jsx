  ...
  return (
    <section className="min-h-[calc(100vh-200px)] pb-[50px] w-full bg-white flex flex-col mb-[30px]">
      <section className="flex md:flex-row flex-col">
        <div className="w-full md:w-[70%] bg-[#d92012] min-h-[70vh] flex relative">
          ...
          <div className="h-full w-full absolute top-0 left-0 flex flex-col px-4 sm:px-6 sm:py-2">
              <div className="w-full h-[70%] flex flex-col-reverse">
                <span className="sm:text-[7em] text-[5.2em] font-[700] leading-[1] uppercase">INVEST.</span>
                <span className="sm:text-[7em] text-[5.2em] font-[700] leading-[1] uppercase">INNOVATE.</span>
                <span className="sm:text-[7em] text-[5.2em] font-[700] leading-[1] uppercase">BUILD.</span>
              </div>
              <div className="w-full h-[30%] flex flex-col-reverse pb-4 justify-between">
                <p className="max-w-[350px] text-white pl-4 border-l-2 border-white ">
                  At {constants?.name} Real Estate, we redefine buying and selling properties through visionary services. Join us to get the best property deals.
                </p>
              </div>
          </div>
        </div>
        <div className="w-full md:w-[30%] min-h-[70vh] flex md:flex-col flex-col-reverse">
          ...
          <div className="md:h-[50%] max-h-max py-[15px] md:py-[0px] border-t border-[rgba(0,0,0,0.25)] md:border-none w-full flex flex-col text-black">
